...
<html lang="en">
  ...
  <div class="container my-5">
    ...
    <a class="btn btn-primary" href="/sqli/category/create.php" role="button">New Category</a>
    <br>
    <table class="table">
       <thead>
        <tr>
  ...
  <tr>
         ...
         <td>
         <a class='btn btn-primary' href='/sqli/category/edit.php?id=$row[categoryid]'>Edit</a>
         <a class='btn btn-primary' href='/sqli/category/delete.php?id=$row[categoryid]'>Delete</a>
